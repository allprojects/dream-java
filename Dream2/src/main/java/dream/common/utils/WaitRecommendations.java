...
/**
 * A WaitRecommendations object is stored inside an event E. It is used by the
 * server to prevent glitches while delivering E to the clients. It tells a
 * client C that it must wait for other events before processing E.
 */
