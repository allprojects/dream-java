...
class ConnectionManager {
	...
	final void sendEvent(UUID id, Event event, Set<String> computedFrom, Set<String> finalExpressions,
			boolean approvedByTokenService) {
	...
	private final void sendAdvertisement(Advertisement adv, AdvType advType, Set<Subscription> subs, boolean isPublic) {
		AdvertisementPacket pkt = (subs != null) ? new AdvertisementPacket(adv, advType, subs, isPublic)
