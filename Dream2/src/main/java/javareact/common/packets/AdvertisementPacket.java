 ...
 * 
 * If the packet is advertising a reactive observable object, it also includes
 * the set of subscriptions required to define all the observable methods the
 * reactive object depends from.
 */
