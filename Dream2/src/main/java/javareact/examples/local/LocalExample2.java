...
public class LocalExample2 {
	...
	public void launch() {
		...
		Signal<Double> reactDouble1 = new Signal<Double>("reactDouble1", () -> obDouble1Proxy.get()
				* obDouble2Proxy.get(), obDouble1Proxy, obDouble2Proxy);

		Signal<Double> reactDouble2 = new Signal<Double>("reactDouble2", () -> obDouble1Proxy.get()
				/ obDouble2Proxy.get(), obDouble1Proxy, obDouble2Proxy);
		...
		new Signal<Double>("sub", () -> reactDouble1Proxy.get() - reactDouble2Proxy.get(), reactDouble1Proxy,
				reactDouble2Proxy).change().addHandler((oldValue, newValue) -> System.out.println(newValue));
