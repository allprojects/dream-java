...
public class LocalExample4 {
	...
	public static void main(String args[]) {
		...
		Signal<Integer> reactInt = new Signal<Integer>("reactInt",
				() -> 10 - 2 + ((obIntProxy.get() * 2) + obIntProxy.get()) / 2, obIntProxy);

		Signal<Double> reactDouble = new Signal<Double>("reactDouble", () -> obDoubleProxy.get() + obDoubleProxy.get()
				* 2, obDoubleProxy);

		Signal<String> reactString = new Signal<String>("reactString", () -> obString1Proxy.get()
				+ obString2Proxy.get(), obString1Proxy, obString2Proxy);

		Signal<Boolean> reactBool = new Signal<Boolean>("reactBool", () -> !obBoolProxy.get(), obBoolProxy);
