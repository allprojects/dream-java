...
public class LockManagerTest {
	...
	public void test1() {
		...
		final LockRequestPacket req1 = new LockRequestPacket(new NodeDescriptor(true), lockNodes, unlockNodes,
				LockType.READ_WRITE);
		assertTrue(manager.processLockRequest(req1));

		final LockRequestPacket req2 = new LockRequestPacket(new NodeDescriptor(true), lockNodes, unlockNodes,
				LockType.READ_WRITE);
		...
		final LockRequestPacket req3 = new LockRequestPacket(new NodeDescriptor(true), lockNodes, unlockNodes,
				LockType.READ_WRITE);
	...
	public void test2() {
		...
		final LockRequestPacket reqAB = new LockRequestPacket(new NodeDescriptor(true), lockNodesAB, unlockNodes,
				LockType.READ_WRITE);
		assertTrue(manager.processLockRequest(reqAB));

		final LockRequestPacket reqA = new LockRequestPacket(new NodeDescriptor(true), lockNodesA, unlockNodes,
				LockType.READ_WRITE);
		assertFalse(manager.processLockRequest(reqA));

		final LockRequestPacket reqB = new LockRequestPacket(new NodeDescriptor(true), lockNodesB, unlockNodes,
				LockType.READ_WRITE);
	...
	public void test3() {
		...
		final LockRequestPacket reqA1 = new LockRequestPacket(new NodeDescriptor(true), lockNodesA, unlockNodes,
				LockType.READ_ONLY);
		assertTrue(manager.processLockRequest(reqA1));

		final LockRequestPacket reqA2 = new LockRequestPacket(new NodeDescriptor(true), lockNodesA, unlockNodes,
				LockType.READ_ONLY);
