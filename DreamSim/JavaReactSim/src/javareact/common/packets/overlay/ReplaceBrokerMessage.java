...
/**
 * This class represents a message for replacing
 * an existing broker with a new broker.
 * 
...
public class ReplaceBrokerMessage extends Message {
	 ...
	 * 
	 * @param existingBroker Existing broker to replace
	 * @param newBroker New broker to replace the existing one
	 */
