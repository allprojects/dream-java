...
/**
 * This is an interface for an Overlay Manager Peerlet. The purpose of
 * implementors of this interface is to give access to the list of neighbor
 * brokers and components.
 * 
...
public interface IOverlayPeerlet {
	 ...
	 * 
	 * @param component
	 *          Existing component to be removed
	 * @return true if the broker has been removed, false if it is not present
	 */
