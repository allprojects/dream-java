...
final class SubscriptionTable {
  private final Map<NetworkAddress, Collection<Subscription>> subs = new HashMap<NetworkAddress, Collection<Subscription>>();
  ...
  final Map<NetworkAddress, Integer> getMatchingNodes(Event ev) {
    Map<NetworkAddress, Integer> result = new HashMap<NetworkAddress, Integer>();
