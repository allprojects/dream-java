...
public class FlowBasedNetworkInterfaceFactory implements NetworkInterfaceFactory {
	 ...
	 * 
	 */	
	public FlowBasedNetworkInterface createNewNetworkInterface(
		...
		FlowBasedNetworkInterface networkInterface = new FlowBasedNetworkInterface(
				measurementLogger, addressToBindTo, networkModel, this);
	...
	/**
	 * Removes all references to the <code>networkInterface</code> from the factory.
	 * 
	 * @param networkInterface the network interface to deallocate
	 */
